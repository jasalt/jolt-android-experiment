...
#define machine_type_name tarm64le
...
#define pb_call_arena_size 0x0
#define pb_fpreg_count 0x0
#define pb_reg_count 0x0
#define phantom_length_disp 0x9
#define phantom_type_disp 0x1
#define popcount_instruction 1
...
#define tc_U_disp 0x1C8
#define tc_V_disp 0x1D0
#define tc_W_disp 0x1D8
#define tc_X_disp 0x1E0
#define tc_Y_disp 0x1E8
...
#define tc_attachments_disp 0x1B0
#define tc_block_counter_disp 0x248
#define tc_cached_frame_disp 0x1C0
...
#define tc_current_errno_source_disp 0x240
#define tc_current_error_disp 0x238
#define tc_current_input_disp 0x228
#define tc_current_mso_disp 0x258
#define tc_current_output_disp 0x230
#define tc_default_record_equal_procedure_disp 0x2B8
#define tc_default_record_hash_procedure_disp 0x2C0
#define tc_disable_count_disp 0x200
#define tc_eap_disp 0xA0
#define tc_esp_disp 0x90
#define tc_fpregs_disp 0x308
#define tc_fxfirst_bit_set_bv_disp 0x270
#define tc_fxlength_bv_disp 0x268
#define tc_gc_data_disp 0x338
...
#define tc_handler_stack_disp 0x1B8
#define tc_instr_counter_disp 0x2E0
#define tc_keyboard_interrupt_pending_disp 0x218
...
#define tc_pb_call_arena_disp 0x338
#define tc_pb_fpregs_disp 0x338
#define tc_pb_regs_disp 0x338
#define tc_random_seed_disp 0x180
#define tc_real_eap_disp 0xD8
#define tc_ret_disp 0xA8
#define tc_save1_disp 0xE0
#define tc_scheme_stack_disp 0x188
#define tc_scheme_stack_size_disp 0x1A0
#define tc_sfd_disp 0x250
#define tc_sfp_disp 0x80
#define tc_signal_interrupt_pending_disp 0x208
#define tc_signal_interrupt_queue_disp 0x210
#define tc_something_pending_disp 0x1F0
...
#define tc_target_machine_disp 0x260
#define tc_td_disp 0xD0
#define tc_threadno_disp 0x220
#define tc_timer_ticks_disp 0x1F8
...
/* derived endianness */
#define native_endianness_is_little 1
...
/* threads */
#define scheme_feature_pthreads 1
#define THREADTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)+1)))
#define THREADTC(x) (*((uptr *)TO_VOIDP((uptr)(x)+9)))

/* thread-context data */
#define DSTBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+760)))
#define SRCBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+768)))
#define U(x) (*((ptr *)TO_VOIDP((uptr)(x)+456)))
#define V(x) (*((ptr *)TO_VOIDP((uptr)(x)+464)))
#define W(x) (*((ptr *)TO_VOIDP((uptr)(x)+472)))
#define X(x) (*((ptr *)TO_VOIDP((uptr)(x)+480)))
#define Y(x) (*((ptr *)TO_VOIDP((uptr)(x)+488)))
#define AC0(x) (*((xptr *)TO_VOIDP((uptr)(x)+112)))
#define AC1(x) (*((xptr *)TO_VOIDP((uptr)(x)+120)))
#define ACTIVE(x) (*((I32 *)TO_VOIDP((uptr)(x)+388)))
#define ALLOCCOUNTER(x) (*((U64 *)TO_VOIDP((uptr)(x)+744)))
#define AP(x) (*((xptr *)TO_VOIDP((uptr)(x)+152)))
#define ARGREGS(x,i) (((xptr *)TO_VOIDP((uptr)(x)+0))[i])
#define ATTACHMENTS(x) (*((ptr *)TO_VOIDP((uptr)(x)+432)))
#define BLOCKCOUNTER(x) (*((ptr *)TO_VOIDP((uptr)(x)+584)))
#define CACHEDFRAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+448)))
#define CCHAIN(x) (*((ptr *)TO_VOIDP((uptr)(x)+368)))
#define CODERANGESTOFLUSH(x) (*((ptr *)TO_VOIDP((uptr)(x)+376)))
#define COMPILEPROFILE(x) (*((ptr *)TO_VOIDP((uptr)(x)+640)))
#define COMPRESSFORMAT(x) (*((ptr *)TO_VOIDP((uptr)(x)+712)))
#define COMPRESSLEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+720)))
#define CP(x) (*((xptr *)TO_VOIDP((uptr)(x)+136)))
#define CURRENTERRNOSOURCE(x) (*((ptr *)TO_VOIDP((uptr)(x)+576)))
#define CURRENTERROR(x) (*((ptr *)TO_VOIDP((uptr)(x)+568)))
#define CURRENTINPUT(x) (*((ptr *)TO_VOIDP((uptr)(x)+552)))
#define CURRENTMSO(x) (*((ptr *)TO_VOIDP((uptr)(x)+600)))
#define CURRENTOUTPUT(x) (*((ptr *)TO_VOIDP((uptr)(x)+560)))
#define DEFAULTRECORDEQUALPROCEDURE(x) (*((ptr *)TO_VOIDP((uptr)(x)+696)))
#define DEFAULTRECORDHASHPROCEDURE(x) (*((ptr *)TO_VOIDP((uptr)(x)+704)))
#define DISABLECOUNT(x) (*((ptr *)TO_VOIDP((uptr)(x)+512)))
#define EAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+160)))
#define ESP(x) (*((xptr *)TO_VOIDP((uptr)(x)+144)))
#define FPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+776))[i])
#define FXFIRSTBITSETBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+624)))
#define FXLENGTHBV(x) (*((ptr *)TO_VOIDP((uptr)(x)+616)))
#define GCDATA(x) (*((xptr *)TO_VOIDP((uptr)(x)+824)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)TO_VOIDP((uptr)(x)+648)))
#define GENERATEPROCEDURESOURCEINFORMATION(x) (*((ptr *)TO_VOIDP((uptr)(x)+656)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)TO_VOIDP((uptr)(x)+664)))
#define GUARDIANENTRIES(x) (*((ptr *)TO_VOIDP((uptr)(x)+360)))
#define HANDLERSTACK(x) (*((ptr *)TO_VOIDP((uptr)(x)+440)))
#define INSTRCOUNTER(x) (*((U64 *)TO_VOIDP((uptr)(x)+736)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)TO_VOIDP((uptr)(x)+536)))
#define LZ4OUTBUFFER(x) (*((xptr *)TO_VOIDP((uptr)(x)+728)))
#define METALEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+632)))
#define OPTIMIZELEVEL(x) (*((ptr *)TO_VOIDP((uptr)(x)+672)))
#define PARAMETERS(x) (*((ptr *)TO_VOIDP((uptr)(x)+752)))
#define PBCALLARENA(x,i) (((uptr *)TO_VOIDP((uptr)(x)+824))[i])
#define PBFPREGS(x,i) (((double *)TO_VOIDP((uptr)(x)+824))[i])
#define PBREGS(x,i) (((uptr *)TO_VOIDP((uptr)(x)+824))[i])
#define RANDOMSEED(x) (*((U32 *)TO_VOIDP((uptr)(x)+384)))
#define REAL_EAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+216)))
#define RET(x) (*((xptr *)TO_VOIDP((uptr)(x)+168)))
#define SAVE1(x) (*((xptr *)TO_VOIDP((uptr)(x)+224)))
#define SCHEMESTACK(x) (*((xptr *)TO_VOIDP((uptr)(x)+392)))
#define SCHEMESTACKSIZE(x) (*((iptr *)TO_VOIDP((uptr)(x)+416)))
#define SFD(x) (*((ptr *)TO_VOIDP((uptr)(x)+592)))
#define SFP(x) (*((xptr *)TO_VOIDP((uptr)(x)+128)))
#define SIGNALINTERRUPTPENDING(x) (*((ptr *)TO_VOIDP((uptr)(x)+520)))
#define SIGNALINTERRUPTQUEUE(x) (*((ptr *)TO_VOIDP((uptr)(x)+528)))
#define SOMETHINGPENDING(x) (*((ptr *)TO_VOIDP((uptr)(x)+496)))
#define STACKCACHE(x) (*((ptr *)TO_VOIDP((uptr)(x)+400)))
#define STACKLINK(x) (*((ptr *)TO_VOIDP((uptr)(x)+408)))
#define SUBSETMODE(x) (*((ptr *)TO_VOIDP((uptr)(x)+680)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)TO_VOIDP((uptr)(x)+688)))
#define TARGETMACHINE(x) (*((ptr *)TO_VOIDP((uptr)(x)+608)))
#define TD(x) (*((xptr *)TO_VOIDP((uptr)(x)+208)))
#define THREADNO(x) (*((ptr *)TO_VOIDP((uptr)(x)+544)))
#define TIMERTICKS(x) (*((ptr *)TO_VOIDP((uptr)(x)+504)))
#define TRAP(x) (*((xptr *)TO_VOIDP((uptr)(x)+176)))
#define TS(x) (*((xptr *)TO_VOIDP((uptr)(x)+200)))
#define VIRTUALREGISTERS(x,i) (((ptr *)TO_VOIDP((uptr)(x)+232))[i])
#define WINDERS(x) (*((ptr *)TO_VOIDP((uptr)(x)+424)))
#define XP(x) (*((xptr *)TO_VOIDP((uptr)(x)+184)))
#define YP(x) (*((xptr *)TO_VOIDP((uptr)(x)+192)))
#define ARGREG(x,i) (((xptr *)TO_VOIDP((uptr)(x)+0))[i])
#define VIRTREG(x,i) (((ptr *)TO_VOIDP((uptr)(x)+232))[i])
