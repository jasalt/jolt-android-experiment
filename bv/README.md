...
- **Dependency Density:** 0.010 (🟢 Healthy) — Issues are well-isolated and can be parallelized
- **Graph Size:** 107 issues with 115 dependencies
...
**By Priority:** P0: 1 | P1: 52 | P2: 48 | P3: 4 | P4: 2

**By Type:** bug: 4 | decision: 2 | epic: 18 | feature: 23 | task: 60
